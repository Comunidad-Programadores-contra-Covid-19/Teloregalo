...
<div class="container">
    ...
    <section id="content">
        ...
        <img src="{{asset('asset/quienesSomos.svg')}}" alt="">
    ...
    <div class="row" id="ntrosProyectos">
        <div class="col-md-12 col-lg-6 mb-3">
            <a href= "https://graciasporcuidarnos.com.ar"><h2>#graciasporcuidarnos  <img src="{{asset('asset/clap1.png')}}" width="40" height="40" class="d-inline-block align-bottom" alt=""></h2></a>
            <p>Acompañá los aplausos a los heroes escribiendo un mensaje de agradecimiento.</p>
        </div>
        <div class="col-md-12 col-lg-6 mb-3">
            <h2>teloregalo <img src="{{asset('asset/logo.svg')}}" width="40" height="40" class="d-inline-block align-bottom" alt=""></h2>
    ...
    <section id="miembrosEquipo" class="box-line pl-3 pr-3">
        ...
        <div class="row" id="equipo">
            <div class="col-md-12 col-lg-12">
                <div class="card-member">
                    <img src="{{asset('asset/Esteban.jpg')}}" alt="" class="avatar">
        ...
        <div class="row">
            <div class="col-md-12 col-lg-3">
                <div class="card-member">
                    <img src="{{asset('asset/Fernando%20Zamora.jpg')}}" alt="" class="avatar">
            ...
            <div class="col-md-12 col-lg-3">
                <div class="card-member">
                    <img src="{{asset('asset/facundo%20luzko.png')}}" alt="" class="avatar">
                    <h6>Facundo Luzko</h6>
            ...
            <div class="col-md-12 col-lg-3">
                <div class="card-member">
                    <img src="{{asset('asset/Julian.jpg')}}" alt="" class="avatar">
        ...
        <div class="row">
            <div class="col-md-12 col-lg-3">
                <div class="card-member">
                    <img src="{{asset('asset/Anto%20Montero.jpg')}}" alt="" class="avatar">
                    <h6>Anto Montero</h6>
            ...
            <div class="col-md-12 col-lg-3">
                <div class="card-member">
                    <img src="{{asset('asset/mariana-ruiz.png')}}" alt="" class="avatar">
                    <h6>Mariana Ruiz</h6>
            ...
            <div class="col-md-12 col-lg-3">
                <div class="card-member">
                    <img src="{{asset('asset/Valeria%20Tenaglia.jpg')}}" alt="" class="avatar">
            ...
            <div class="col-md-12 col-lg-3">
                <div class="card-member">
                    <img src="{{asset('asset/Rocio%20Oestereicher.jpg')}}" alt="" class="avatar">
        ...
        <div class="row">
            <div class="col-md-12 col-lg-4">
                <div class="card-member">
                    <img src="{{asset('asset/Juan%20Pablo%20Larraza.jpg')}}" alt="" class="avatar">
            ...
            <div class="col-md-12 col-lg-4">
                <div class="card-member">
                    <img src="{{asset('asset/Alex.png')}}" alt="" class="avatar">
                    <h6>Alex Bordón</h6>
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-3">
                <div class="card-member">
                    <img src="{{asset('asset/NicolasLiendro.jpeg')}}" alt="" class="avatar">
            ...
            <div class="col-md-12 col-lg-3">
                <div class="card-member">
                    <img src="{{asset('asset/Nahuel%20Villagra.jpg')}}" alt="" class="avatar">
    ...
    <section id="contactanos">
        <h3>Contactanos</h3>
        <a href="mailto:hola@teloregalo.com.ar?Subject=Mensage"><p><img src="{{asset('asset/sobreAbierto.svg')}}" alt="">hola@teloregalo.com.ar</p></a>
        <a href="mailto:hola@graciasporcuidarnos.com.ar?Subject=Mensage"><p><img src="{{asset('asset/sobreAbierto.svg')}}" alt="">hola@graciasporcuidarnos.com.ar</p></a>
    </section>
