        ...
        <div class="col-lg-6">
            ...
            @endif
                    <div class="form-group ">
                        ...
                        <input type="text"id="inputNombrecomercio" placeholder="" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $storeInfo->name }}" required autocomplete="name" autofocus>
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="inputEmail" readonly value="{{ $userInfo->email }}">
                    </div>
                    <div class="form-group">
        ...
        <div class="col-lg-6">
            <section>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="inputNombreApellido" placeholder="" value="{{ $userInfo->name}}">
                    </div>
                    <div class="form-group">
                        <label for="inputTel">Teléfono de contacto</label>
                        <input type="text" id="inputTel" placeholder="" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ $storeInfo->phone }}" required autocomplete="phone">
                        @error('phone')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
        ...
        <div class="col-lg-6">
            <section>
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text"class="form-control @error('description') is-invalid @enderror" name="description"  required autocomplete="description" id="inputDesc" rows="3">{{ $storeInfo->description }}
                        </textarea>
                    </div>

                    <div class="form-group">
                        <label for="inputFace">Link perfil de Facebook</label>
                        <input type="text" name="facebook" class="form-control" id="inputFace" value="{{ $storeInfo->facebook }}">
