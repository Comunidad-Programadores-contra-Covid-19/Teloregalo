<body>
    <table style="max-width: 600px; padding: 10px; margin: 0 auto; border-collapse: collapse;">
        ...
        <tr>
            <td style="text-align: center;">
                <p style="font-family: Poppins Sans-serif,sans-serif; font-size: 40px; margin: 0;">¡Tenés una venta!</p>
            </td>
        </tr>
        <tr>
            <td style="text-align: center;">
                <p style="font-family: Poppins Sans-serif,sans-serif; font-size: 19px; line-height: 36px; text-align: justify;
                    color: #263238; padding: 10px;">¡Genial! Los vecinos te encontraron en <strong>teloregalo.com.ar </strong> y compraron tus productos.
                     Ahora pueden agradecer a un héroe mediante un regalo. <br>
                     Tu dinero está en tu cuenta de Mercado Pago
                  Cuando el héroe se acerque a tu comercio para retirar el regalo,
               ingresá a <strong> “Entregar productos”</strong> desde tu perfil y cargá el código que el héroe te dicte. <br>
                       </p>

                      <h2>¡Animate a seguir cargando productos!</h2>
            </td>
        </tr>
        <tr>
            <td style="text-align: center;">
                <a href="{{ route('login.stores') }}" style="color:#2E2C2C; background-color: #96D293; border: 0.1rem solid;
