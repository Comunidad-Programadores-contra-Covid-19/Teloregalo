...
<body>
    <table style="max-width: 600px; padding: 10px; margin: 0 auto; border-collapse: collapse;">
        ...
        <tr>
            <td style="text-align: center;">
                <a href="{{ $msg }}" style="color:#2E2C2C; background-color: #96D293; border: 0.1rem solid;
            border-color: #96D293; border-radius: 1rem; padding: 0.3rem 1rem; font-weight: 400;
            text-align: center; font-family: Poppins Sans-serif,sans-serif; font-size: 18px;">Verificar Email</a>
            </td>
        </tr>
